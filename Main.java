...
public class Main {
	...
	{
		PhongHoc ph1 = new PhongLyThuyet("P1", "Day B", 100, 10, true);
		listPH.themPhongHoc(ph1);
		PhongHoc ph2 = new PhongLyThuyet("P2", "Day A", 200, 20, true);
		listPH.themPhongHoc(ph2);
		PhongHoc ph3 = new PhongLyThuyet("P3", "Day A", 100, 10, true);
		listPH.themPhongHoc(ph3);
		PhongHoc ph4 = new PhongLyThuyet("P4", "Day C", 200, 20, false);
		listPH.themPhongHoc(ph4);
		
		PhongHoc ph5 = new PhongMayTinh("P5", "Day A", 200, 10, 10);
		listPH.themPhongHoc(ph5);
		PhongHoc ph6 = new PhongMayTinh("P6", "Day C", 300, 30, 15);
		listPH.themPhongHoc(ph6);
		PhongHoc ph7 = new PhongMayTinh("P7", "Day A", 200, 20, 10);
		listPH.themPhongHoc(ph7);
		PhongHoc ph8 = new PhongMayTinh("P8", "Day B", 250, 15, 15);
		listPH.themPhongHoc(ph8);
		
		PhongHoc ph9 = new PhongThiNghiem("P9", "Day C", 200, 20, 200, true);
		listPH.themPhongHoc(ph9);
		PhongHoc ph10 = new PhongThiNghiem("P10", "Day A", 200, 20, 200, false);
		listPH.themPhongHoc(ph10);
		PhongHoc ph11 = new PhongThiNghiem("P11", "Day B", 250, 25, 250, true);
		listPH.themPhongHoc(ph11);
		PhongHoc ph12 = new PhongThiNghiem("P12", "Day A", 200, 20, 200, true);
